...
<div id="page">
	...
	<div id="content">
		<div class="post">
			<h1 class="title">Welcome <%= session.getAttribute("name") %> to Stock details </h1>	
		</div>
		<%
		try{ 
		...
		<tr><td>Owner Name</td><td><input type="text" name="t1" value="<%= rs.getString(2) %>" /></td></tr>
		<tr><td>Shop Name</td><td><input type="text" name="t2" value="<%= rs.getString(3) %>" /></td></tr>
		<tr><td>Address</td><td><input type="text" name="t3" value="<%= rs.getString(4) %>" /></td></tr>
