...
<div id="page">
	...
	<div id="content">
		<div class="post">
			<h1 class="title">Welcome <%= session.getAttribute("name") %> to your Details</a></h1>
		</div>
		<%
		...
		try{
		ResultSet rs=st.executeQuery("select * from customer where uid='"+s1+"'");
		if(rs.next()){
			...
			if(z>0)
			out.print("<font color=green size=3>"+s2+" Details Updated Successfully</font>");
		}
		con.close();
  }catch(Exception e){ 
    out.print(e);
